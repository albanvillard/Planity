      ...
      <div className="flex flex-wrap items-center justify-between sm:justify-end gap-3.5 w-full sm:w-auto">
        ...
        {user.photoURL ? (
          <img
            ...
            className="w-10 h-10 rounded-full border border-indigo-100 dark:border-slate-800 shadow-sm shrink-0"
          />
        ) : (
        ...
        <button
          onClick={onLogout}
          type="button"
          className="flex items-center justify-center gap-1.5 bg-slate-100 hover:bg-slate-200/80 dark:bg-slate-800 dark:hover:bg-slate-700/80 text-slate-600 dark:text-slate-300 hover:text-slate-800 dark:hover:text-white font-bold px-3 py-2 rounded-xl transition-all duration-200 text-xs cursor-pointer active:scale-95"
        ...
        <button
          ...
          type="button"
          className={`flex items-center justify-center gap-1.5 px-3 py-2 rounded-xl font-bold text-xs transition-all duration-200 cursor-pointer active:scale-95 border border-transparent ${
            activeTab === "profile"
              ? "bg-indigo-600 text-white shadow-md shadow-indigo-600/10 dark:bg-indigo-500"
              : "bg-slate-100 hover:bg-slate-200/80 dark:bg-slate-800 dark:hover:bg-slate-700/80 text-slate-600 dark:text-slate-300 hover:text-slate-800 dark:hover:text-white"
          }`}
